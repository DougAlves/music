<template>
  <main>
    ...
    <!-- Form -->
    <section class="container mx-auto mt-6" id="commets">
...
export default {
  ...
  data() {
    return {
      ...
      alert_message: 'Comment being submited',
      sort: '1',
    };
  },
  computed: {
    ...
    sortedComments() {
      const oi = this.comments.slice().sort((a, b) => {
        if (this.sort === '1') {
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      this.alert_message = 'Comment being submited';
